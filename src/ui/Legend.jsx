...
function Legend({ className, setInfoOpen, infoOpen }) {
  return (
    <div
      className={`relative flex w-full flex-col items-center gap-3 rounded-lg px-2 py-4 pb-15 sm:translate-0 sm:flex-row sm:gap-0 sm:pb-5 lg:translate-y-1/4 ${className}`}
    >
